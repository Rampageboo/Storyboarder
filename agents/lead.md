...
Read `AGENTS.md`, `docs/ai-workflow/execution-network.md`, and this file.
...
implementation stops and the framing returns to Claude. If Claude materially
shaped the failed framing, use a fresh reviewer. Write the escalation into the
task record and return it, so it reaches both the Owner and the next session:
