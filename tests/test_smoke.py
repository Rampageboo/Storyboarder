...
class StoryboardSmokeTests(unittest.TestCase):
    ...
    def test_es_module_bootstrap_loads_migrated_leaf_scripts(self) -> None:
        ...
        self.assertIn('import * as dispatch from "../core/dispatch.js"', bootstrap_js)
        self.assertIn('import * as api from "../core/api.js"', bootstrap_js)
        ...
        self.assertNotIn('"core/api.js"', main_js)
        self.assertNotIn('"core/dispatch.js"', main_js)
