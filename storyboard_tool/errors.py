...
class AppErrorCode:
    ...
    PLUGIN_UPGRADE_REQUIRED = "PLUGIN_UPGRADE_REQUIRED"
    PLUGIN_PROTOCOL_REJECTED = "PLUGIN_PROTOCOL_REJECTED"
    PLUGIN_WRITE_INTENT_REJECTED = "PLUGIN_WRITE_INTENT_REJECTED"
