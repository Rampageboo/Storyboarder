/**
 * Primitive object factory and preview-style helpers for the Scene3D workspace.
 * Logic mirrors storyboard_tool/web/static/runtime/scene3d.js (createMeshFromSpec, etc.).
 */
