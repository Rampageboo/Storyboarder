...
- Multi-agent execution with a separate implementer and verifier: the Lead
  loads `execution-network.md` and `agents/lead.md`; assigned Implementer and
  Verifier sessions load their role file and assignment
